// Command forge is the entry point for the Forge Context Server.
//
// Usage:
...
import (
	...
	"github.com/DMT123/forge-context-server/internal/server"
	"github.com/DMT123/forge-context-server/internal/sources"
	"github.com/DMT123/forge-context-server/internal/sources/memories"
	"github.com/DMT123/forge-context-server/internal/sources/obsidian"
	"github.com/DMT123/forge-context-server/internal/sources/workspace"
)
...
func main() {
	...
	logger.Info("Forge Context Server starting",
